...
const setData = () => {
    ...
    inputForm.up = props.formData.up;
    inputForm.receiver = props.formData.receiver;
    inputForm.signer = props.formData.signer;
    inputForm.verificator = props.formData.verificator;
    inputForm.tembusan = props.formData.tembusan;
    inputForm.lampiran = props.formData.lampiran;
    dataForm.value = props.formData.data_form;
}
                            ...
                            <!-- <template> -->
                                <div class="flex justify-content-center p-fluid">
                                    <div v-focustrap class="cards">
                                        ...
                                        <div class="field">
                                            <Textarea v-model="inputFormTujuan.address" rows="5" cols="30" placeholder="Alamat" />
                                        </div>
                        ...
                        <div class="p-fluid formgrid grid">
                            <div class="field col-12 md:col-1 mb-0 align-self-end">
                                ...
                                <div class="switch-Tandatangan">
                                    <InputSwitch v-model="penandatanganExternalSwitch" @click="setSignerExternalSwitch()"/>
                                </div>
                            </div>
                            <div class="field col-12 md:col-11 mb-0" v-if="penandatanganExternalSwitch">
                                <MultiSelect
                                    inputId="signer"
                                    v-model="selectedPenandatanganExternal"
                                    display="chip"
