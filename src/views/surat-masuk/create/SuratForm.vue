...
const getDocumentNatures = () => {
    suratService.getDocumentNatures(3).then((data) => (optionSifatSurat.value = data));
}
            ...
            <template v-slot:content>
                <div class="p-fluid formgrid grid mt-3">
                    <div class="field col-12 md:col-6">
                        ...
                        <Dropdown inputId="class" v-model="selectedCategory" :options="optionCategory"
                            @change="setCategory($event)" optionLabel="name" placeholder="Select a Category"
                    ...
                    <div class="field col-12 md:col-6">
                        <div v-if="selectedCategory" class="flex flex-row justify-content-between">
                            <div class="field flex flex-column">
                                ...
                                <InputSwitch v-model="isReply" trueValue="1" falseValue="0" @change="setValFlag"
                                    :disabled="enabledForm" />
                            </div>
                            <div class="field flex flex-column">
                                <label for="email">To Finance</label>
                                <InputSwitch v-model="isFinance" trueValue="1" falseValue="0" @change="setValFlag"
                                    :disabled="enabledForm" />
                            </div>
                            <div class="field flex flex-column">
                                <!-- <label for="email">Secret Document</label>
                                <InputSwitch v-model="isSecret" trueValue="1" falseValue="0" @change="setValFlag"
                                    :disabled="enabledForm" /> -->
                            </div>
                        </div>
                    </div>
                ...
                <div class="p-fluid formgrid grid mt-3">
                    ...
                    <div class="field col-12 md:col-6">
                        ...
                        <InputText id="perihal" type="text" v-model="inputForm.perihal" required="true" autofocus
                            :class="{ 'p-invalid': submitted && !inputForm.perihal }" :disabled="enabledForm" />
                    ...
                    <div class="field col-12 md:col-6">
                        ...
                        <MultiSelect inputId="divisi" v-model="selectedDivisi" display="chip" :options="optionDivisi"
                            ...
                            autofocus :class="{ 'p-invalid': submitted && !selectedDivisi }" :disabled="enabledForm" />
                    ...
                    <div class="field col-12 md:col-6">
                        ...
                        <div class="p-inputgroup flex-1">
                            <MultiSelect inputId="tujuan" display="chip" v-model="selectedTujuan"
                                ...
                                :class="{ 'p-invalid': submitted && !selectedTujuan }" :disabled="enabledForm" />
                        </div>
                    ...
                    <div class="field col-12 md:col-6">
                        ...
                        <Dropdown inputId="verificator" v-model="selectedVerificator" display="chip"
                            ...
                            :class="{ 'p-invalid': submitted && !selectedVerificator }" :disabled="enabledForm" />
                                ...
                                <div class="flex flex-wrap justify-content-between align-items-center flex-1 gap-2">
                                    <div class="flex gap-2">
                                        <Button @click="chooseCallback()" icon="pi pi-upload" style="padding: 6px 20px;"
                                            outlined :disabled="enabledForm">Choose</Button>
                                    </div>
                                </div>
                            </template>
                                    ...
                                    <div v-for="(file, index) of inputForm.attachment"
                                        ...
                                        <div class="col-1">
                                            <Button icon="pi pi-send"
                                                @click="onSendFile(file, removeFileCallback, index)" severity="info"
                                                style="width: 100%;" :disabled="enabledForm" />
                                        </div>
                                        <div class="col-1">
                                            <Button icon="pi pi-times"
                                                @click="onRemoveTemplatingFile(file, removeFileCallback, index)"
                                                severity="danger" style="width: 100%;" :disabled="enabledForm" />
                                        </div>
                                    </div>
                                </div>
                            </template>
                    ...
                    <template v-for="(item, idx) in dataForm" :key="idx">
                        <div class="field col-12 md:col-6">
                            ...
                            <Calendar v-if="item.type === '2' || item.type === '5'" :id="item.parameter"
                                v-model="item.value" :disabled="enabledForm" autofocus
                            ...
                            <Calendar v-if="item.type === '2' && item.type === '8'" :id="item.parameter"
                                ...
                                @date-select="validasiLimitTanggalCuti(item.value)" :disabled="enabledForm" autofocus
                                :class="{ 'p-invalid': submitted && !item.value }" />
