...
async function convertFileToBase64() {
    const attach = props.formData.attachment;
    dataPdf.value = 'data:application/pdf;base64,'+ props.formData.content;
    if (attach.length > 0) {
...
const getCategoryName = () => {
    return (props.formData.category) ? props.formData.category.name : "";
}
