    ...
    <TreeTable :value="SuratData" :loading="loading" responsiveLayout="scroll">
        ...
        <Column header="Aksi" :exportable="false" headerStyle="min-width:14rem" expander >
            <template #body="slotProps">
                <Button icon="pi pi-eye" outlined rounded class="mr-2 " @click="viewSuratCompleteMasuk(slotProps.node)"/>
                <Button v-if="slotProps.node.parent === 0" icon="pi pi-reply" outlined rounded severity="success" class="mr-2 " @click="replySuratMasuk(slotProps.node)" />
        ...
        <Column field="varificator" header="Varificator" headerStyle="min-width:12rem;">
            <template #body="slotProps">
